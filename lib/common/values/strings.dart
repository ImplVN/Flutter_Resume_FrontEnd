...
class StringConst {
  ...
  static const String CERTIFICATIONS = "証明書";
  static const String EMAIL_VALUE = "davidcobbina47@gmail.com";

  // Home Page
  static const String HI = "はじめまして";
  static const String DEV_INTRO = "ゴックと申します";
  static const String DEV_TITLE = "ソフトウェア開発者です";
  static const String DEV_DESC = "Mobile Engineer / Brse";
  static const String SEE_MY_WORKS = "プロジェクト一覧";
  static const String SCROLL_DOWN = "Scroll Down";
  static const String CRAFTED_WITH_LOVE = "プロジェクト一覧";
  static const String SELECTION = "以下は最近対応したプロジェクトです";
  static const String THERES_MORE = "もっと見る";
  static const String VIEW_ALL_PROJECTS = "全てのプロジェクト";
  ...
  static const String COPYRIGHT = "©  2023年$DEV_NAMEによって作成されました";
  ...
  static const String WORK_TOGETHER = "一緒に仕事しましょう。";
  static const String AVAILABLE_FOR_FREELANCE = "コンサルティングおよびフリーランスの仕事が可能です。";
  static const String SAY_HELLO = "Say Hello";

  // Works Page
  static const String VIEW_PROJECT = "プロジェクトを見る";
  ...
  static const String BUILT_WITH_FLUTTER = "で作成しました。";
  ...
  static const String DEV_NAME = "ゴックディン";
