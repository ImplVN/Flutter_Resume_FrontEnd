...
class ImagePath {
  ...
  // Icons
  static const String ICONS_FLUTTER = "$iconDir/resume_flutter.png";
  static const String ICONS_MYSQL = "$iconDir/resume_mysql.png";
  static const String ICONS_PHP = "$iconDir/resume_php.png";
  static const String ICONS_REACT = "$iconDir/resume_react.png";
  static const String ICONS_RUBY = "$iconDir/resume_ruby.png";
  static const String ICONS_SWIFT = "$iconDir/resume_swift.png";
  // Messi
  static const String IMAGE_MESSI = "$iconDir/messi.jpeg";
}
